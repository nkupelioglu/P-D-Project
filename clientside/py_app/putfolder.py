...
server1_getsize_address = ('192.168.121.3', 3006)
server2_getsize_address = ('192.168.121.4', 3006)
server3_getsize_address = ('192.168.121.6', 3006)

server1_exists_address = ('192.168.121.3', 3007)
server2_exists_address = ('192.168.121.4', 3007)
server3_exists_address = ('192.168.121.6', 3007)

server1_address = ('192.168.121.3', 3005)
server2_address = ('192.168.121.4', 3005)
server3_address = ('192.168.121.6', 3005)
